        ...
        >
          ...
          <div className="flex flex-col">
            ...
            <div className='flex px-4 mt-3'>
              {cats.map((ele,ind)=>{
                    return (
                      <div key={ele} className="flex justify-center items-center space-x-2 mr-4 bg-gray-200 py-1 rounded-md">
                        <p>{ele}</p>
                        <p
          ...
          <textarea rows={15} cols={30} className='px-4 py-2 outline-none' placeholder='enter the description'/>
          <button className='bg-black w-full md:w-[20%] mx-auto text-white font-semibold px-4 py-2 text-lg  md:text-xl'>Create</button>
        </form>
      </div>
    </div>
  );
